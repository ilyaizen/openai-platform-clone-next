...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "relative h-svh w-[--sidebar-width] bg-transparent transition-[width] duration-700 ease-out",
      ...
      <div
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] duration-700 ease-out md:flex",
          side === "left"
...
const SidebarPlayground = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(
  ({ className, ...props }, ref) => {
    return <div ref={ref} data-sidebar="playground" className={cn("flex items-center p-2", className)} {...props} />;
  }
);
SidebarPlayground.displayName = "SidebarPlayground";
    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          "group-data-[collapsible=icon]:invisible group-data-[collapsible=icon]:h-0 group-data-[collapsible=icon]:opacity-0",
          className
        )}
        {...props}
      />
